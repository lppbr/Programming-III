/*
 COSC2436 Lab 1, Instructor: Thayer
 Name: Travis Neel
 Semester: Fall 2016 BLUE
...
/* Extra credit (will the function template work for input of a string?)
 
 No, strings do not work in function templates. Templates only work for numeric data and 
 limits are met with const char* type data, which can reference a string from a
 seperate container or struct possibly?
